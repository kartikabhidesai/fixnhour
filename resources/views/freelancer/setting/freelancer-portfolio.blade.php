                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="school_from">Project Title : <span class="required">*</span></label>
                                <div class="input-group col-md-12">
                                    {{ Form::text('school_from', null, array('class' => 'form-control', 'id' => 'school_from', 'placeholder' => '')) }}
                                </div>
                            </div>       
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="school_to">Select Contract : <span class="required">*</span></label>
                                <div class="input-group col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group col-md-12">
                                    {{ Form::textarea('school_from', null, array('class' => 'form-control', 'id' => 'school_from', 'placeholder' => '')) }}
                                </div>
                            </div> 
                            <div class="form-group">
...
<!--                                <label for="school_to">Sub Category : <span class="required">*</span></label>-->
                            ...
                            <div class="form-group">
                                <label for="school_to">Project URL(Optional) : <span class="required">*</span></label>
                                <div class="input-group col-md-12">
                                    {{ Form::text('school_from', null, array('class' => 'form-control', 'id' => 'school_from', 'placeholder' => 'URL')) }}
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="school_to">Completion Date (Optional) : <span class="required">*</span></label>
                                <div class="input-group col-md-12">
                                    {{ Form::text('school_from', null, array('class' => 'form-control', 'id' => 'school_from', 'placeholder' => 'yyyy-mm-dd')) }}
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="school_to">Skills (Optional) : <span class="required">*</span></label>
                                <div class="input-group col-md-12">
                                    {{ Form::text('school_from', null, array('class' => 'form-control', 'id' => 'school_from', 'placeholder' => 'Enter Skills Here')) }}
                                </div>
                            </div>
                        </div>
                    </div>
