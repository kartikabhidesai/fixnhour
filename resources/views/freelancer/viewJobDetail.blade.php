    ...
    <section class="max-height-footer home-page gray-bg">
        <div class="container">
            <div class="row jobdetail">
                ...
                <div class="col-md-3 padding-top80">
                    <a href="{{ url('/freelancer/proposol/1')}}" class="btn default btn-green col-md-12">Submit A Proposol</a>
                    <button type="submit" class="btn default btn-bottom col-md-12">Save Job</button>
                </div>
            </div>
