        ...
        <div class="container pad-botm-30">
            <div class="left-profile">
                <div class="profile-top full">
                    <div class="profile-left">  <img src="images/user-large.jpg" alt="#" />
                    ...
                    <div class="profile-right">
                        <div class="block relative">
                            <h2 class="profile-name">James Deal <img src="images/right-icon.png" alt="#" /></h2>
                                                    ...
                                                    <div id="skill">
                                                        ...
                                                        <div class="skil-outer">
                                                            <div class="skills-row text-center">
                                                                <div class="skills-img"><img src="images/skil-80.jpg" alt="#"></div>
                                                                <p>PHOTOSHOP</p>
                                                            </div>
                                                            <div class="skills-row text-center">
                                                                <div class="skills-img"><img src="images/skil-91.jpg" alt="#"></div>
                                                                <p>Illustrator</p>
                                                            </div>
                                                            <div class="skills-row text-center">
                                                                <div class="skills-img"><img src="images/skil-95.jpg" alt="#"></div>
                                                                <p>CORAL</p>
                                                            </div>
                                                            <div class="skills-row text-center">
                                                                <div class="skills-img"><img src="images/skil-80.jpg" alt="#"></div>
                                            ...
                                            <div class="gray-box white-box">
                                                ...
                                                <div class="clear-full identity-outer">
                                                    <ul class="identity-list">
                                                        ...
                                                        <li><span class="identity-left">Verification</span> <span class="identity-right"> <a href="#"><img src="images/icon-small-right.png" alt="#" /></a> <a href="#" class="icon-green">$</a> <a href="#" class="icon-green"><i class="fa-phone fa"></i></a> <a href="#" class="icon-green"><i class="fa-list fa"></i></a> </span> </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
